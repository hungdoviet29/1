...
const ProductScreen = () => {
    ...
    const handleAddToCart = async () => {
        try {
            ...
            await axios.post('http://192.168.3.106:3000/cart/add', {
                userId,
    ...
    const toggleFavorite = async () => {
        try {
            ...
            if (isFavorite) {
                ...
                await axios.post('http://192.168.3.106:3000/removeFavoriteProduct', {
                    userId,
                    productId: product._id,
                });
                setIsFavorite(false);
                ...
                await axios.post('http://192.168.3.106:3000/addFavoriteProduct', {
                    userId,
                    productId: product._id,
                });
                setIsFavorite(true);
