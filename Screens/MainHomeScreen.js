  ...
  const fetchAllData = async () => {
    ...
    try {
      const [popularResponse, saleResponse, trendingResponse] =
        await Promise.all([
          axios.get('http://192.168.0.3:3000/LapTop/getPopularLapTop'),
          axios.get('http://192.168.0.3:3000/LapTop/getSaleLapTop'),
          axios.get('http://192.168.0.3:3000/LapTop/getTrendingLapTop'),
        ]);
