  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={styles.infoItem1}
          onPress={() => handlePress('Ảnh đại diện')}>
          <Text style={styles.label}>Ảnh đại diện</Text>
          <Image source={{uri: userData.avatar}} style={styles.avatar} />
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.infoItem2}
          onPress={() => handlePress('Họ và tên')}>
        ...
        <TouchableOpacity
          style={styles.infoItem4}
          onPress={() => handlePress('Ngày sinh')}>
        ...
        <TouchableOpacity
          style={styles.infoItem3}
          onPress={() => handlePress('Số điện thoại')}>
